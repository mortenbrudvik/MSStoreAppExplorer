...
{
    /// <summary>
    /// Code from: https://github.com/khalidabuhakmeh/ConsoleTables
    ///
    ...
    public class LoggerTableOptions
    {
        ...
        /// </summary>
        public TextWriterAdapter OutputTo { get; set; } = new ConsoleTextWriterAdapter();
    }

    public abstract class TextWriterAdapter
    {
        public abstract void WriteLine(string message);
    }

    public class ConsoleTextWriterAdapter : TextWriterAdapter
    {
        public override void WriteLine(string message) => System.Console.Out.WriteLine(message);
    }
